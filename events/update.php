...
if($result["error"]){
  header('Location: ' . $GLOBALS['DOMAIN'] . '/events/edit.php?eventUid=' . $_POST['event']['event_uid'] . '&calendarId=' . $_POST['event']['calendar_id'] . '&' . ErrorToQueryStringParams($result["error"]));
